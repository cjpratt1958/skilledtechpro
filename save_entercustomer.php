...
$Incident = $date;
    ...
    $errormsg = "no errors";
		...
		$sql_cust = "INSERT INTO skilledtech.customers (fname,lname,name,company,contact,address,city,state,zip,cphone,hphone,wphone,email,terms,billsto,custnotes,date)
		VALUES ('$fname','$lname','$name','$company','$contact','$address','$city','$state','$zip','$cphone','$hphone','$wphone','$email','$terms','$billsto','$custnotes','$date')";
